    ...
    <!-- changes -->
        ...
        <style>
            *{
              ...
              .selection input[type="submit"]:nth-child(odd){
                float: right;
                rotate: 160deg;
                transform: rotate(180deg);
              }
              .selection input[type="submit"]:nth-child(even){
                float: left;
                rotate: 20deg;
              }
              .footer{
		...
		<div class="background">
            ...
            <div class="park">
              ...
              <div class="selection">
                  ...
                  <form action="spot.php"></form>
                  <input type="submit" value="Spot 1">
                  <input type="submit" value="Spot 2">
                  <input type="submit" value="Spot 3">
                  <input type="submit" value="Spot 4">
                  <input type="submit" value="Spot 5">
                  <input type="submit" value="Spot 6">
